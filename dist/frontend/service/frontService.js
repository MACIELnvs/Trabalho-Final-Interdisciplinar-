...
export async function listarCartas() {
    try {
        ...
        return await tratarResposta(response, "Erro ao buscar cartas.");
    }
    catch (erro) {
        console.error(erro);
        return [];
...
export async function pesquisarCartasCriterio(criterio) {
    try {
        const criterioUrl = encodeURIComponent(criterio);
        const response = await fetch(`${API_CARTAS}/pesquisar/${criterioUrl}`);
        return await tratarResposta(response, "Erro ao pesquisar cartas por critério.");
    }
    catch (erro) {
        console.error(erro);
        return [];
...
export async function pesquisarCartasPorColecao(criterio) {
    try {
        const criterioUrl = encodeURIComponent(criterio);
        const response = await fetch(`${API_CARTAS}/colecao/${criterioUrl}`);
        return await tratarResposta(response, "Erro ao pesquisar cartas por coleção.");
    }
    catch (erro) {
        console.error(erro);
        return [];
...
export async function buscarCarta(id) {
    try {
        ...
        return await tratarResposta(response, "Erro ao buscar carta.");
    }
    catch (erro) {
        console.error(erro);
        return null;
...
export async function criarCarta(id, nome, frameType) {
    try {
        ...
        return await tratarResposta(response, "Erro ao criar carta.");
    }
    catch (erro) {
        console.error(erro);
        return null;
...
export async function atualizarCarta(id, nome, frameType) {
    try {
        const nomeUrl = encodeURIComponent(nome);
        const frameTypeUrl = encodeURIComponent(frameType);
        const response = await fetch(`${API_CARTAS}/atualizar/${id}/${nomeUrl}/${frameTypeUrl}`);
        return await tratarResposta(response, "Erro ao atualizar carta.");
    }
    catch (erro) {
        console.error(erro);
        return null;
...
export async function removerCarta(id) {
    try {
        const response = await fetch(`${API_CARTAS}/${id}`, {
            method: "DELETE"
        });
